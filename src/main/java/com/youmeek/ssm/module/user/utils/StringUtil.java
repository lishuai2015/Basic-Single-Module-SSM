 ...
 */
package com.youmeek.ssm.module.user.utils;
...
public final class StringUtil {
	...
	public static String determineFullyQualifiedClassName(
			String defaultPackage, String name) {
	...
	private static boolean isValidPropertyName(String name, String prefix) {
		...
		// the name has to start with the prefix and have at least one more
		// character
